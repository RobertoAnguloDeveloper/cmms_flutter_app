    ...
    try {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Questions assigned successfully'),
    ...
    return Dialog(
      ...
      child: Container(
        ...
        constraints: BoxConstraints(
          ...
          maxWidth:
              MediaQuery.of(context).size.width * (isLandscape ? 0.9 : 0.9),
        ),
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            padding: const EdgeInsets.symmetric(
              vertical: 7.0, // Altura del botón
              horizontal: 22.0, // Ancho del botón
            ),
            shape: RoundedRectangleBorder(
