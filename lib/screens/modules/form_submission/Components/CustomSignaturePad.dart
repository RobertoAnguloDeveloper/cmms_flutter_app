...
class CustomSignaturePadState extends State<CustomSignaturePad> {
  ...
  void initState() {
    ...
    // Listen for orientation changes to update the UI if needed
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // This ensures we have a context before accessing MediaQuery
      if (mounted) {
  ...
  void _showExpandedSignatureView() {
    // Allow both portrait and landscape orientations for the signature view
    ...
    _overlayEntry = OverlayEntry(
      builder: (context) {
        // Calculate dimensions for the expanded signature area based on orientation
        ...
        if (isLandscape) {
          // In landscape, use a larger percentage of width and smaller of height
          availableWidth = screenSize.width * 0.75;
          availableHeight = screenSize.height * 0.8;
        } else {
          // In portrait, use standard values
          availableWidth = screenSize.width * 0.9;
          availableHeight = screenSize.height * 0.7;
        }
