    ...
    if (questionType == 'signature') {
      return CustomSignaturePad(
        onSignatureCaptured: (file, {String? author, String? position}) {
          if (file != null) {
            setState(() {
              // Almacenar la ruta para validación, pero NO la agregues a _attachedFiles.
              answers[questionId] = file.path;

              // Guardar en signatureFiles para luego subir con createAttachment(..., isSignature=true)
