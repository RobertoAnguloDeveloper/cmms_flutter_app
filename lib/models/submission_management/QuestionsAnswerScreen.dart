    ...
    try {
      ...
      if (signatureFiles.isNotEmpty) {
        ...
        for (var entry in signatureFiles.entries) {
          ...
          // ****************************************************************
          // AQUÍ se cambió para usar 'position' de signatureData en lugar
          // de question['text'], de modo que se respete el texto escrito
          // por el usuario en el pad de firmas.
          // ****************************************************************
          ...
          if (file != null) {
            setState(() {
              ...
              signatureFiles[questionId.toString()] = {
                'path': file.path,
                // En lugar de question['text'], usar sólo "author" y "position"
            ...
            setState(() {
              if (answers.containsKey(questionId)) {
                // Si borran la firma, quitamos la referencia.
                answers.remove(questionId);
                signatureFiles.remove(questionId.toString());
                // Ya no tocamos _attachedFiles, porque no agregamos nada en primer lugar.
                _validateFormSubmission();
              }
            });
          }
